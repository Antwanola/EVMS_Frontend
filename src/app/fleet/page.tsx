...
export default function FleetVehicleInventory() {
  ...
  const vehicles: Vehicle[] = [
    {
      ...
      model: 'Tesla Model Y',
      year: '2023',
      image: 'https://images.unsplash.com/photo-1619767886558-efdc7b4b4a8c',
      alt: 'Tesla Model Y',
      vin: '1N4BL4CV5HC...',
      capacity: '75 kWh',
      motor: 'PMSM (Dual)',
    ...
    },
    {
      ...
      year: '2023',
      image: 'https://images.unsplash.com/photo-1617814076231-9f6db30fcd21',
      alt: 'Ford Lightning',
      vin: '5YJ3E1EB4KF...',
      capacity: '131 kWh',
      motor: 'Dual Motor',
  ...
  return (
    <Flex minH="100vh" bg="gray.50" _dark={{ bg: '#101922' }}>
